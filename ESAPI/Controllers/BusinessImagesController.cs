...
namespace ESAPI.Controllers
{
    ...
    public class BusinessImagesController : BaseController
    {
        ...
        public async Task<ActionResult<List<BusinessImagesDto>>> GetBusinessImageDetails(Int64 id)
        {
        ...
        public async Task<IActionResult> UploadBusinessImages()
        {
            try
            {
                ...
                var request = new UploadBusinessImagesCommand() {
                    UserId = Convert.ToInt16(formCollection["userid"]),
                    BusinessId = Convert.ToInt16(formCollection["businessId"]),
